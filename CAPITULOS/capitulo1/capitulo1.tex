...
La Lengua de Señas Mexicana (LSM) es la lengua natural utilizada por la comunidad sorda en México. A pesar de su importancia, la comunicación entre personas sordas y oyentes sigue siendo un desafío debido a la falta de intérpretes y al desconocimiento generalizado de la LSM. Este proyecto busca abordar esta problemática mediante el desarrollo de un sistema de reconocimiento de señas que utiliza tecnología de aprendizaje profundo (\textit{deep learning}) para traducir la LSM al español.
