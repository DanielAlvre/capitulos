...
La Lengua de Señas Mexicana (LSM) es la lengua natural utilizada por la comunidad sorda en México. La comunicación entre personas sordas y oyentes se ve dificultada por la falta de intérpretes y el desconocimiento generalizado de la LSM, a pesar de la importancia de esta lengua. Este proyecto busca abordar la problemática de la falta de comunicación efectiva entre personas sordas y oyentes en México, específicamente en el contexto médico mediante el desarrollo de un sistema de reconocimiento de señas que utiliza tecnología de aprendizaje profundo (\textit{deep learning}) para traducir la LSM al español.
...
Además, la integración de servicios en la nube, como \textbf{AWS S3} y \textbf{SQS} \cite{ref5}, garantizará la escalabilidad y el procesamiento eficiente de los datos. Complementando estas tecnologías, se incorporará una API de \textbf{Text-To-Speech} u otras alternativas similares, permitiendo que el sistema traduzca las señas a palabras tanto visuales como auditivas. Ofreciendo una interacción más integral y accesible, especialmente en contextos donde la comunicación efectiva es fundamental.
...
En la Figura \ref{fig:diagrama_sistema}, se observa el funcionamiento del sistema para la parte del entrenamiento:

% ---  Ajusta el caption para que sea vertical ---

\begin{figure}[H]
    \includegraphics[scale=0.20]{CAPITULOS/capitulo1/DIAGRAMAINTRO}
    \centering
    \caption[Diagrama del funcionamiento del entrenamiento del sistema]{Diagrama del funcionamiento del entrenamiento del sistema}
    \label{fig:diagrama_sistema}
\end{figure}

En la Figura \ref{fig:diagrama_sistema2}, se observa el funcionamiento del sistema para la parte del reconocimiento:

% ---  Ajusta el caption para que sea vertical ---

\begin{figure}[H]
    \includegraphics[scale=0.5]{CAPITULOS/capitulo1/Diagrama2}
    \centering
    \caption[Diagrama del funcionamiento del reconocimiento del sistema]{Diagrama del funcionamiento del reconocimiento del sistema}
    \label{fig:diagrama_sistema2}
\end{figure}
