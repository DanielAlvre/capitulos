...
Las medidas de tendencia central son herramientas estadísticas que nos permiten resumir la localización de los datos, es decir, nos ayudan a identificar el valor alrededor del cual se centran los datos. Estas medidas son esenciales para el análisis de datos en cualquier investigación, incluyendo el análisis de las muestras de Lengua de Señas Mexicana (LSM) en este proyecto.

Algunos de los objetivos de la utilización de las medidas de tendencia central son:

\begin{itemize}
    \item Mostrar en qué lugar se ubica el elemento promedio o típico del grupo.
    \item Comparar o interpretar cualquier valor en relación con el puntaje central o típico.
    \item Comparar el valor adquirido por una misma variable en dos diferentes ocasiones.
    \item Comparar los resultados medios obtenidos por dos o más grupos.
\end{itemize}

En el contexto del análisis de las muestras de LSM, las medidas de tendencia central nos permiten:

\begin{itemize}
    \item Identificar la posición promedio de las manos, la cabeza o el cuerpo en las señas.
    \item Comparar la posición de las manos en diferentes señas.
    \item Analizar la variabilidad en la ejecución de las señas entre diferentes individuos.
    \item Comparar la posición de las manos en la misma seña realizada en diferentes momentos.
\end{itemize}

Las medidas de tendencia central que se utilizarán en este proyecto son:

\begin{itemize}
    \item \textbf{Media:} La media aritmética es el valor obtenido al sumar todos los valores de un conjunto de datos y dividir entre el número de datos. En el análisis de LSM, la media puede utilizarse para calcular la posición promedio de las manos en una seña.
\end{itemize}
...
\begin{itemize}
    ...
    \item $x_i$ son los valores de los datos.
    \item $n$ es el número de datos.
    \item \textbf{Moda:} La moda es el valor que más se repite en un conjunto de datos. En el análisis de LSM, la moda puede utilizarse para identificar la posición más común de las manos en una seña.
\end{itemize}
...
\subsubsection{Convolución en 2 Dimensiones}
